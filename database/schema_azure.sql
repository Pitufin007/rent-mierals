...
-- ──────────────────────────────────────────────────────────────────
-- 4.6 TABLA: mantenimiento
-- Rangos de fechas en que una máquina está en mantención. Bloquea esos
-- días en el calendario de reserva (se pintan naranjo). Independiente
-- del estado global: la disponibilidad se maneja por fechas.
-- ──────────────────────────────────────────────────────────────────
